...
const repoLink = (req,res) => {
    ...
    shell.exec("docker run -v " + directory+"/datacollection/"+repoName + ":/data -it code-maat-app -l /data/logfile.log -c git2 >" + repoName + "_code_metrics_authors.csv")
    shell.exec("docker run -v " + directory+"/datacollection/"+repoName + ":/data -it code-maat-app -l /data/logfile.log -c git2 -a coupling >" + repoName + "_code_metrics_coupling.csv")
    shell.exec("docker run -v " + directory+"/datacollection/"+repoName + ":/data -it code-maat-app -l /data/logfile.log -c git2 -a age >" + repoName + "_code_metrics_age.csv")
